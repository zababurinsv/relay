...
(async ()=>{
  ...
  const announceAddresses = ['/dns4/web3-star.herokuapp.com/tcp/443/wss']
  let node = await createRelayServer({
    idListener,
    announceAddresses
  })
  await node.start()
...
//         TODO check "What is next?" section
  ...
  //
  // const idListener = await PeerId.createFromJSON(PeerListener)
  // const node = await createLibp2p({ peerId: idListener })
  //
  // await node.start()
  //
// })()
